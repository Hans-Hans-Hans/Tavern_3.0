...
export function CommandPalette({ onSelectRoom, onSelectServer, onSettings, onSearch, onCreate, onContacts, onMessage }: { onSelectRoom: (id: string) => void; onSelectServer: (id: string) => void; onSettings: (tab?: string) => void; onSearch: () => void; onCreate?: () => void; onContacts?: () => void; onMessage?: (userId: string) => void | Promise<unknown> }) {
  ...
  const commands = [
    { id: 'search', name: 'Search messages', keywords: 'find history', icon: <Search size={17}/>, run: onSearch },
