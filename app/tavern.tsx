...
import { RoomReportReview } from './room-report-review';
...
function Workspace() {
 ...
 <main className='main-workspace'>
  ...
  <div className='conversation-layout'><section className='conversation-main'>
   ...
   {view==='channel'&&tab==='messages'&&forumMode?<ForumChannel key={channel} roomId={channel} serverId={currentServer?.id} messages={messages} onOpen={setThread} onSent={()=>loadMessages(true)} onProfile={id=>openProfile(id,channel)} hasMore={hasMore} loadingHistory={busy} onLoadHistory={loadOlder}/>:view==='channel'&&tab==='work'?<CollaborationBoard key={channel} roomId={channel}/>:<div className='message-scroll' ref={scroll} onScroll={() => { if (scroll.current)
