...
export function Workspace() {
 ...
 {modal === 'server' && <ServerDialog open naming={prefs.naming} onClose={() => setModal('')} onCreated={async (id, roomId) => { await loadBootstrap(); setSelectedServer(id); setGuild(roomId || ''); setView('channel'); }}/>}
