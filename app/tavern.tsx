...
export function Workspace() {
 ...
 <main className='main-workspace'>
  ...
  <div className='conversation-layout'><section className='conversation-main'>
   ...
   {view === 'channel' && tab === 'messages' && !voiceMode && <div className='typing-indicator' aria-live='polite'>{!prefs.focus && matrixTyping(channel).length > 0 ? matrixTyping(channel).slice(0, 3).join(', ') + (matrixTyping(channel).length === 1 ? ' is typing…' : ' are typing…') : ''}</div>}
