...
function fixture() {
  ...
  const lib = loadTs('../lib/server-afk.ts', { './matrix': matrix, './roles': roles, './channel-administration': { canEditConversationState: () => authority, checkedConversationState: async () => { if (!authority) throw new Error('Permission changed'); return currentClient; } } });
