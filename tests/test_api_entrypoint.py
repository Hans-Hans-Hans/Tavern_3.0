...
def inspect(app,**kwargs):
    import integrations_admin,admin_resources,community_api,invitation_privacy,admin_users,moderation,room_authority,server
    ...
    assert moderation.APIError is expected
    assert room_authority.APIError is expected
