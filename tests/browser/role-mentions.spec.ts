...
async function fixture(page: Page) {
  ...
  await page.route(url => url.pathname === '/lib/community.ts', route => route.fulfill({ contentType: 'application/javascript', body: 'export const cleanMxc=value=>typeof value===\"string\"&&value.startsWith(\"mxc://\")?value:\"\";export const cropProfileImage=()=>{throw Error(\"Unexpected emoji crop\")};export const uploadProfileImage=()=>{throw Error(\"Unexpected emoji upload\")};export const serverChannelIds=()=>[];export const readServerLayout=()=>({version:1,categories:[],channels:[]});' }));
