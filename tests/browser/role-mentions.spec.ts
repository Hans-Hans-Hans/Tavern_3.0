...
async function fixture(page: Page) {
  ...
  await page.route(url => url.pathname === '/lib/community.ts', route => route.fulfill({ contentType: 'application/javascript', body: 'export const serverChannelIds=()=>[];export const readServerLayout=()=>({version:1,categories:[],channels:[]});' }));
