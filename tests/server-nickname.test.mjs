...
const community = loadTs('../lib/community.ts', { './matrix': matrix, './roles': roles, './server-nickname': nicknames, './matrix-media': loadTs('../lib/matrix-media.ts', {}), './response-image': loadTs('../lib/response-image.ts', {}) });
