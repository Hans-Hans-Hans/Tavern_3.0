> **UNSUPPORTED / HISTORICAL. Do not execute these recipes for current V3.**
> Preserve existing data and use [the canonical installation guide](../INSTALLATION.md).
> Old helper commands and image tags below are retained only as migration history.
