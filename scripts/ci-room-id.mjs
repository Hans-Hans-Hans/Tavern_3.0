...
const markers = new Set(['io.tavern.ci_dm', 'io.tavern.ci_invitation_privacy', 'io.tavern.ci_system', 'io.tavern.ci_afk', 'io.tavern.ci_audio', 'io.tavern.ci_channel_admission', 'io.tavern.ci_room_removal']);
