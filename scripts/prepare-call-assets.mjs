...
for(const name of ['embedded-call-telemetry','conference-telemetry-protocol']){
...
await writeFile('public/element-call/SOURCE.txt','Element Call embedded 0.25.0\nCorresponding upstream source: https://github.com/element-hq/element-call/tree/efde51b8c1e136fca17d38ec408b0a7dbb2f17e9\nTavern modifications: externalized two inline bootstrap scripts, supplied local compatibility config, and attached bounded read-only telemetry to the existing call view-model lifecycle. Reproducible modification scripts: scripts/prepare-call-assets.mjs and scripts/transform-call-telemetry.mjs; bridge source: lib/embedded-call-telemetry.ts and lib/conference-telemetry-protocol.ts in the Tavern source distribution. Composed source maps retain corresponding upstream sources and include the added bridge source.\n');
